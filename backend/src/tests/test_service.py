...
def test_redirect_user_sql_injection():
    # Базовые SQL-инъекции (только печатаемые ASCII символы)
    injection_tests = [
...
def test_redirect_user_edge_cases():
    ...
    for case in edge_cases:
        ...
        print(f"Case: {case} -> Status: {response.status_code}")


def test_redirect_user_valid_cases():
